...
<head>
    ...
    <title>Fresh Meal Bazar Organic</title>
        ...
        <div class="site-content-wrapper">
            ...
            <div class="site-content">
                ...
                <nav  > 
                    ...
                    <div class="navbar magic-shadow">
                        <div class="container flex justify-center">
                            ...
                            <a href="http://localhost/FreshMealBazar/fruits.php#" class="active">Fruits </a>
                            <a href="http://localhost/FreshMealBazar/vagetables.php#">Vagetables</a>
                            <a href="http://localhost/FreshMealBazar/organic_food.php#"class="active">Organic Food</a>
                ...
                <section class="top-products">
                    <div class="container">
                         <h1 class="section-heading "> Organic Food</h1>
                         ...
                         <div class="food-slider">
                             <div class="food-card magic-shadow-sm">
                                 <div class="product-image flex items-center justify-center">
                                     <img src="./images/organic1.jpg" alt="">
                                 </div>
                                 <hr>
                                 <div>
                                     <h2 class="text-center">Gram Flour</h2>
                             ...
                             <div class="food-card magic-shadow-sm">
                                <div class="product-image flex items-center justify-center">
                                    <img src="./images/organic2.jpg" alt="">
                                </div>
                                <hr>
                                <div>
                                    <h2 class="text-center">Methi</h2>
                                    <div class="stars flex justify-center items-center ">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                            ...
                            <div class="food-card magic-shadow-sm">
                                ...
                                <hr>
                                <div>
                                    <h2 class="text-center">Green Mango </h2>
                                    <div class="stars flex justify-center items-center ">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                 ...
                 -->
                         <div class="food-slider">
                             <div class="food-card magic-shadow-sm">
                                 <div class="product-image flex items-center justify-center">
                                     <img src="./images/organic3jpg" alt="">
                                 </div>
                                 <hr>
                                 <div>
                                     <h2 class="text-center">Mug dall</h2>
                                     <div class="stars flex justify-center items-center ">
                                         <img src="./icons/start-filled.svg" alt="">
                                         <img src="./icons/start-filled.svg" alt="">
                                         <img src="./icons/start-filled.svg" alt="">
                             ...
                             <div class="food-card magic-shadow-sm">
                                <div class="product-image flex items-center justify-center">
                                    <img src="./images/organic4.jpg" alt="">
                                </div>
                                <hr>
                                <div>
                                    <h2 class="text-center">Muri</h2>
                                    <div class="stars flex justify-center items-center ">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                            ...
                            <div class="food-card magic-shadow-sm">
                                <div class="product-image flex items-center justify-center">
                                    <img src="./images/organic5.jpg" alt="">
                                </div>
                                <hr>
                                <div>
                                    <h2 class="text-center">Dall </h2>
                                    <div class="stars flex justify-center items-center ">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                            ...
                            <div class="food-card magic-shadow-sm">
                                <div class="product-image flex items-center justify-center">
                                    <img src="./images/organic6.png" alt="">
                                </div>
                                <hr>
                                <div>
                                    <h2 class="text-center">Butel Dall</h2>
                                    <div class="stars flex justify-center items-center ">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
