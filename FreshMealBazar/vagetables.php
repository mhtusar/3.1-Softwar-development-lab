...
<head>
    ...
    <title>Fresh Meal Bazar Vagetables</title>
        ...
        <div class="site-content-wrapper">
            ...
            <div class="site-content">
                ...
                <nav > 
                    ...
                    <div class="navbar magic-shadow">
                        <div class="container flex justify-center">
                            ...
                            <a href="http://localhost/FreshMealBazar/vagetables.php#" class="active">Vagetables</a>
                            <a href="http://localhost/FreshMealBazar/organic_food.php#">Organic Food</a>
                            <a href="http://localhost/FreshMealBazar/fish.php#">Fresh Fish</a>
                ...
                <section class="top-products">
                    <div class="container">
                         <h1 class="section-heading "> Vagetables</h1>
                         ...
                         <div class="food-slider">
                             <div class="food-card magic-shadow-sm">
                                 <div class="product-image flex items-center justify-center">
                                     <img src="./images/vagetables1.jpg" alt="">
                                 </div>
                                 <hr>
                                 <div>
                                     <h2 class="text-center">Lemon(kagzi)</h2>
                             ...
                             <div class="food-card magic-shadow-sm">
                                <div class="product-image flex items-center justify-center">
                                <img src="./images/vagetables2.jpg" alt="">

                                </div>
                                <hr>
                                <div>
                                    <h2 class="text-center">Chili(Bombay)</h2>
                                    <div class="stars flex justify-center items-center ">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                            ...
                            <div class="food-card magic-shadow-sm">
                                <div class="product-image flex items-center justify-center">
                                <img src="./images/vagetables3.jpg" alt="">

                                </div>
                                <hr>
                                <div>
                                    <h2 class="text-center">Beet Kg</h2>
                                    <div class="stars flex justify-center items-center ">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                            ...
                            <div class="food-card magic-shadow-sm">
                                <div class="product-image flex items-center justify-center">
                                <img src="./images/vagetables4.jpg" alt="">
                 ...
                 -->
                         <div class="food-slider">
                             <div class="food-card magic-shadow-sm">
                                 <div class="product-image flex items-center justify-center">
                                 <img src="./images/vagetables5.jpg" alt="">

                                 </div>
                                 <hr>
                                 <div>
                                     <h2 class="text-center">Cariander Leaf</h2>
                                     <div class="stars flex justify-center items-center ">
                                         <img src="./icons/start-filled.svg" alt="">
                                         <img src="./icons/start-filled.svg" alt="">
                                         <img src="./icons/start-filled.svg" alt="">
                             ...
                             <div class="food-card magic-shadow-sm">
                                <div class="product-image flex items-center justify-center">
                                <img src="./images/vagetables6.jpg" alt="">
                                </div>
                                <hr>
                                <div>
                                    <h2 class="text-center">Lal Shak</h2>
                                    <div class="stars flex justify-center items-center ">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                            ...
                            <div class="food-card magic-shadow-sm">
                                <div class="product-image flex items-center justify-center">
                                <img src="./images/vagetables7.jpg" alt="">

                                </div>
                                <hr>
                                <div>
                                    <h2 class="text-center">Green Banana</h2>
                                    <div class="stars flex justify-center items-center ">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                            ...
                            <div class="food-card magic-shadow-sm">
                                <div class="product-image flex items-center justify-center">
                                <img src="./images/vagetables8.jpg" alt="">
                                </div>
                                <hr>
                                <div>
                                    <h2 class="text-center">Diamond Aloo</h2>
                                    <div class="stars flex justify-center items-center ">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
