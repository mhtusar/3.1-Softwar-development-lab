        ...
        <div class="site-content-wrapper">
            ...
            <div class="site-content">
                ...
                <nav > 
                    ...
                    <div class="navbar magic-shadow">
                        <div class="container flex justify-center">
                            ...
                            <a href="http://localhost/FreshMealBazar/meat.php#"class="active">Fresh Meat</a>
                ...
                <section class="top-products">
                    <div class="container">
                         <h1 class="section-heading ">Fresh Meat</h1>
                        ...
                        <div class="slider">
                         ...
                         <div class="food-slider">
                             <div class="food-card magic-shadow-sm">
                                 ...
                                 <hr>
                                 <div>
                                     <h2 class="text-center">Boiler</h2>
                             ...
                             <div class="food-card magic-shadow-sm">
                                <div class="product-image flex items-center justify-center">
                                    <img src="./images/meat2.jpg" alt="">
                                </div>
                                <hr>
                                <div>
                                    <h2 class="text-center">koyel</h2>
                                    <div class="stars flex justify-center items-center ">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                            ...
                            <div class="food-card magic-shadow-sm">
                                <div class="product-image flex items-center justify-center">
                                    <img src="./images/meat3.jpg" alt="">
                                </div>
                                <hr>
                                <div>
                                    <h2 class="text-center">Kubotor</h2>
                                    <div class="stars flex justify-center items-center ">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                 ...
                 -->
                         <div class="food-slider">
                             <div class="food-card magic-shadow-sm">
                                 <div class="product-image flex items-center justify-center">
                                     <img src="./images/meat5.jpg" alt="">
                                 </div>
                                 <hr>
                                 <div>
                                     <h2 class="text-center">Khasir Koliza</h2>
                                     <div class="stars flex justify-center items-center ">
                                         <img src="./icons/start-filled.svg" alt="">
                                         <img src="./icons/start-filled.svg" alt="">
                                         <img src="./icons/start-filled.svg" alt="">
                             ...
                             <div class="food-card magic-shadow-sm">
                                <div class="product-image flex items-center justify-center">
                                    <img src="./images/meat6.jpg" alt="">
                                </div>
                                <hr>
                                <div>
                                    <h2 class="text-center">khasir Mutton</h2>
                                    <div class="stars flex justify-center items-center ">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                            ...
                            <div class="food-card magic-shadow-sm">
                                <div class="product-image flex items-center justify-center">
                                    <img src="./images/meat7.jpg" alt="">
                                </div>
                                <hr>
                                <div>
                                    <h2 class="text-center">Roast Chicken</h2>
                                    <div class="stars flex justify-center items-center ">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
                                        <img src="./icons/start-filled.svg" alt="">
